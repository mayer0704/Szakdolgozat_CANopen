...
/*******************************************************************************
   OBJECT DICTIONARY
*******************************************************************************/
   #define CO_OD_NoOfElements             68//55
...
/*2201      */ typedef struct{
			   UNSIGNED8      maxSubIndex;
			   UNSIGNED8	  Status;
			   UNSIGNED8	  ControlWord;
			   UNSIGNED8      Decay_latch;
			   UNSIGNED8      Decay_act;
			   UNSIGNED8      Current_latch;
			   UNSIGNED8      Current_act;
			   UNSIGNED16     Speed_latch;
			   UNSIGNED16     Speed_act;
			   UNSIGNED16     Position_latch;
			   UNSIGNED16     Position_act;
			   UNSIGNED8      Direction_latch;
			   UNSIGNED8      Direction_act;
			   UNSIGNED8      Limit_switch;//bitek külön értelmezve
			   }              OD_Granulate_Dispenser_t;
...
/*2204      */ typedef struct{
			   ...
			   UNSIGNED8      Direction_act;
			   UNSIGNED8      Limit_switch;
			   }			  OD_Compression_Press_t;//figyelj comp és extr fordítva van a CANeds-ben
...
/*2207      */ typedef struct{
			   ...
			   UNSIGNED8	  Status;
			   UNSIGNED8	  ControlWord;
			   UNSIGNED16	  Value_act;
			   UNSIGNED16     Flowmeter_Value_set;
			   UNSIGNED8	  Flowmeter_Gain;
			   UNSIGNED8	  Flowmeter_Offset;
			   UNSIGNED8	  Valve_status;
			   }              OD_Water_Dispenser_t;
...
/*2208      */ typedef struct{
			   ...
			   UNSIGNED8	  Gain;
			   UNSIGNED8	  Offset;
			   }              OD_Water_Pressure_Sensor_t;

/*2209      */ typedef struct{
	           UNSIGNED8      maxSubIndex;
			   UNSIGNED8	  Status;
			   UNSIGNED8	  ControlWord;
			   UNSIGNED8	  Temperature_latch;
			   UNSIGNED8	  Temperature_act;
			   UNSIGNED8	  Type;
			   UNSIGNED8	  Heating_Status;
			   }              OD_Water_Heating_t;
...
///*4001      */ typedef struct{
			   //UNSIGNED8      maxSubIndex;
			   //UNSIGNED8	  Error_sub1;
			   //UNSIGNED8	  Error_sub2;
			   //UNSIGNED8	  Error_sub3;
			   //UNSIGNED8	  Error_sub4;
			   //UNSIGNED8	  Error_sub5;
			   //UNSIGNED8	  Error_sub6;
			   //UNSIGNED8	  Error_sub7;
			   //UNSIGNED8	  Error_sub8;
			   //UNSIGNED8	  Error_sub9;
			   //UNSIGNED8	  Error_subA;
			   //UNSIGNED8	  Error_subB;
			   //UNSIGNED8	  Error_subC;
			   //}              OD_Error_t;
///*4002      */ typedef struct{
			   //UNSIGNED8      maxSubIndex;
			   //UNSIGNED8	  Warning_sub1;
			   //UNSIGNED8	  Warning_sub2;
			   //UNSIGNED8	  Warning_sub3;
			   //UNSIGNED8	  Warning_sub4;
			   //UNSIGNED8	  Warning_sub5;
			   //UNSIGNED8	  Warning_sub6;
			   //UNSIGNED8	  Warning_sub7;
			   //UNSIGNED8	  Warning_sub8;
			   //UNSIGNED8	  Warning_sub9;
			   //UNSIGNED8	  Warning_subA;
			   //UNSIGNED8	  Warning_subB;
			   //UNSIGNED8	  Warning_subC;
			   //}              OD_Warning_t;
/*******************************************************************************
...
/*2130      */ OD_time_t      time;
/**********************SAJÁT OBJEKTUMOK***********************************/
/*2201      */ OD_Granulate_Dispenser_t         Granulate_Dispenser;
/*2202      */ OD_Granulate_Level_Sensor_t      Granulate_Level_Sensor;
/*2203      */ OD_Knife_t						Knife;
/*2204      */ OD_Extrusion_Press_t				Extrusion_Press;
/*2205      */ OD_Compression_Press_t			Compression_Press;
/*2206      */ OD_Main_Axis_t					Main_Axis;
/*2207      */ OD_Water_Dispenser_t				Water_Dispenser;
/*2208      */ OD_Water_Pressure_Sensor_t		Water_Pressure_Sensor;
/*2209      */ OD_Water_Heating_t				Water_Heating;
/*220a      */ OD_Conveyor_t					Conveyor;

/*3001		*/ UNSIGNED8						Fryer_OrdersWaiting;

/*4001      */ UNSIGNED8						Error[8];
/*4002      */ UNSIGNED8						Warning[8];
/*************************************************************************/
...
/*2201, Data Type: OD_Granulate_Dispenser_t*/
	  #define  OD_Granulate_Dispenser                    CO_OD_RAM.Granulate_Dispenser

/*2202, Data Type: OD_Granulate_Level_Sensor_t*/
	  #define  OD_Granulate_Level_Sensor				 CO_OD_RAM.Granulate_Level_Sensor

/*2203, Data Type: OD_Knife_t*/
	  #define  OD_Knife									 CO_OD_RAM.Knife

/*2204, Data Type: OD_Extrusion_Press_t*/
	  #define  OD_Extrusion_Press						 CO_OD_RAM.Extrusion_Press

/*2205, Data Type: OD_Compression_Press_t*/
	  #define  OD_Compression_Press						 CO_OD_RAM.Compression_Press

/*2206, Data Type: OD_Main_Axis_t*/
	  #define  OD_Main_Axis								 CO_OD_RAM.Main_Axis

/*2207, Data Type: OD_Water_Dispenser_t*/
	  #define  OD_Water_Dispenser						 CO_OD_RAM.Water_Dispenser

/*2208, Data Type: OD_Water_Pressure_Sensor_t*/
	  #define  OD_Water_Pressure_Sensor					 CO_OD_RAM.Water_Pressure_Sensor

/*2209, Data Type: OD_Water_Heating_t*/
	  #define  OD_Water_Heating							 CO_OD_RAM.Water_Heating

/*220a, Data Type: OD_Conveyor_t*/
	  #define  OD_Conveyor								 CO_OD_RAM.Conveyor

/*3001, Data Type: UNSIGNED8 */
      #define  OD_Fryer_OrdersWaiting                    CO_OD_RAM.Fryer_OrdersWaiting

/*4001, Data Type: OD_Error_t*/	  
	  #define  OD_Error									 CO_OD_RAM.Error
	  #define  OD_Error_length							 8
/*4002, Data Type: OD_Warnig_t*/
	  #define  OD_Warning								 CO_OD_RAM.Warning
	  #define  OD_Warning_length						 8
